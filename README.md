...
* [IPGeolocation.io](https://ipgeolocation.io/) - IP geolocation API bundling timezone and currency data in the same response. Free developer tier: 1,000 requests/day (~30K/month), no credit card required.
